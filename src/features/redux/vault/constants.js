...
export const VAULT_FETCH_LAST_HARVEST_BEGIN = 'VAULT_FETCH_LAST_HARVEST_BEGIN';
export const VAULT_FETCH_LAST_HARVEST_SUCCESS = 'VAULT_FETCH_LAST_HARVEST_SUCCESS';
export const VAULT_FETCH_LAST_HARVEST_FAILURE = 'VAULT_FETCH_LAST_HARVEST_FAILURE';

export const VAULT_FETCH_PERFRMANCE_FEE_BEGIN = 'VAULT_FETCH_PERFRMANCE_FEE_BEGIN';
export const VAULT_FETCH_PERFRMANCE_FEE_SUCCESS = 'VAULT_FETCH_PERFRMANCE_FEE_SUCCESS';
export const VAULT_FETCH_PERFRMANCE_FEE_FAILURE = 'VAULT_FETCH_PERFRMANCE_FEE_FAILURE';
